class Cars:
    ...
    def getInfo(self):
        return f"Registrační značka vozidla je {self.SPZ}, značka a typ vozidla je {self.znacka} a najelo celkem {self.pocet_najetych_km}."
...
pocet_najetych_km = int(pocet_najetych_km)
print(peugeot.vrat_auto(pocet_najetych_km, pocet_pujcenych_dni))
