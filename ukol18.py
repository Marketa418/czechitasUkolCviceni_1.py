...
class Uchazec (Kontakt):
    ...
    def get_Info(self, zapis_z_pohovoru):
...
pepa = Uchazec("Pepa urbanec", "pepa.urbanec.seznam.cz", "26. 2. 2021", "Pepa byl dokonalý uchazeč.")
martin = Uchazec("Martin Straka", "martin.straka.gmail.com", "5. 4. 2021", "")
alena = Uchazec("Alena Mánesová", "alenka.z.rise.divu.com", "3. 3. 2021", "Umí komunikovat s lidmi.")
print(pepa.pridej_zapis())
print(martin.pridej_zapis())
print(alena.pridej_zapis())